<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <button class="text-sm text-gray-600" id="togglePasswordButton" type="button"
...
<script>
    ...
    function togglePasswordVisibility(passwordInputId, passwordConfirmationInputId) {
    var passwordInput = document.getElementById(passwordInputId);
    var passwordConfirmationInput = document.getElementById(passwordConfirmationInputId);
